...
#define I_DIAG_PIN                          PG12
#define J_DIAG_PIN                          PG13
#define K_DIAG_PIN                          PG14
...
//
  ...
  #if J_HOME_TO_MIN
    #define J_MAX_PIN                E4_DIAG_PIN  // PWRDET
  #else
    #define J_MIN_PIN                E4_DIAG_PIN  // PWRDET
  #endif
#elif NEEDS_J_MINMAX
  #ifndef J_MIN_PIN
  ...
  #if K_HOME_TO_MIN
    #define K_MAX_PIN                E5_DIAG_PIN  // PWRDET
  #else
    #define K_MIN_PIN                E5_DIAG_PIN  // PWRDET
  #endif
#elif NEEDS_K_MINMAX
  #ifndef K_MIN_PIN
